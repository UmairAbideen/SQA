...
class AuditorTrainingController extends Controller
{
    public function view(Request $request)
    {
        ...
        return view('auditor.training.view', compact('allStaff'));
    }

    public function form()
    {
        // Include 'org' in selected columns
        $users = User::select('id', 'username', 'ses_no', 'org')->get();
        return view('auditor.training.add', compact('users'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->route('auditor.training.view')
            ->with('status', 'New Staff Authorization has been added successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        $users = User::all();
        return view('auditor.training.update', compact('staff', 'users'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('auditor.training.view')
            ->with('status', 'Staff authorization record updated successfully.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('auditor.training.view')
            ->with('status', 'Staff authorization deleted successfully.');
    }
