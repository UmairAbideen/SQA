...
class AuditorComponentCertifyingStaffController extends Controller
{
    public function create()
    {
        ...
        return view('auditor.training.ses.ccs.add', compact('staff'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('auditor.training.ses.ccs.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'cma_no' => 'nullable|string|max:255',
            'scope' => 'nullable|string',
            'limitation' => 'nullable|string|max:255',
        ]);
        ...
        return redirect()->route('auditor.training.ccs.single', ['id' => $id])
    ...
    public function show($id)
    {
        ...
        return view('auditor.training.ses.ccs.single', compact('record'));
    }
    ...
    public function print($id)
    {
        ...
        return PDF::loadView('auditor.training.ses.ccs.pdf', compact('record', 'training'))
