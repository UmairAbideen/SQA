...
class AuditorAircraftCertifyingStaffController extends Controller
{
    public function create()
    {
        ...
        return view('auditor.training.ses.acs.add', compact('staff'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('auditor.training.ses.acs.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('auditor.training.acs.single', ['id' => $id])
    ...
    public function show($id)
    {
        ...
        return view('auditor.training.ses.acs.single', compact('record'));
    }
    ...
    public function print($id)
    {
        ...
        return Pdf::loadView('auditor.training.ses.acs.pdf', compact('record', 'training'))
