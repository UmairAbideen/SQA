...
class AuditeeRampInspectionController extends Controller
{
    // ================== Ramp Inspection (Auditee) ==================

    public function view()
    {
        $rampInspections = RampInspection::with('rampInspectionFinding')->get(); // preload findings
        return view('auditee.rampinspection.view', ['rampInspections' => $rampInspections]);
    }

    public function form()
    {
        return view('auditee.rampinspection.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('auditee.rampinspection.update', ['rampinspection' => $rampinspection]);
    }
    ...
    public function generatePdf($id)
    {
        ...
        return Pdf::loadView('auditee.rampinspection.pdf', compact('rampInspection'))
    ...
    public function exportRampInspectionsByDate(Request $request)
    {
        ...
        return Pdf::loadView('auditee.rampinspection.range_pdf', compact('rampInspections', 'start', 'end'))
            ->setPaper('a4', 'landscape')
    ...
    public function findingView($id)
    {
        ...
        return view('auditee.rampinspection.finding.view', [
    ...
    {
        $rampInspection = RampInspection::find($id);
        return view('auditee.rampinspection.finding.add', ['rampInspection' => $rampInspection]);
    }
    ...
    public function findingEdit($id)
    {
        ...
        return view('auditee.rampinspection.finding.update', [
    ...
    public function printRampFinding($findingId)
    {
        ...
        $pdf = Pdf::loadView('auditee.rampinspection.finding.pdf', compact('rampInspection', 'finding'))
            ->setPaper('a4', 'landscape');
    ...
    public function exportRampFindingsByDateRange(Request $request, $rampId)
    {
        ...
        $pdf = Pdf::loadView('auditee.rampinspection.finding.range_pdf', compact('rampInspection', 'findings', 'startDate', 'endDate'))
            ->setPaper('a4', 'landscape');
    ...
    public function replyView($id)
    {
        ...
        return view('auditee.rampinspection.finding.reply.view', [
    ...
    public function replyForm($id)
    {
        ...
        return view('auditee.rampinspection.finding.reply.add', [
            'rampInspectionFinding' => $rampInspectionFinding,
        ]);
    }
    ...
    public function replyCreate(Request $request)
    {
        ...
        return redirect()
            ->route('auditee.rampinspection.finding.reply.view', $rampInspectionFinding->id)
    ...
    public function replyEdit($id)
    {
        ...
        return view('auditee.rampinspection.finding.reply.update', [
    ...
    public function printRampReplies($replyId)
    {
        ...
        $pdf = Pdf::loadView('auditee.rampinspection.finding.reply.pdf', compact('rampInspection', 'finding', 'reply'))
            ->setPaper('a4', 'landscape');
    ...
    public function exportRepliesOfRampFindingByDateRange(Request $request, $findingId)
    {
        ...
        return Pdf::loadView('auditee.rampinspection.finding.reply.range_pdf', compact('rampInspection', 'finding', 'replies', 'startDate', 'endDate'))
            ->setPaper('a4', 'landscape')
