...
class DirectorRampInspectionController extends Controller
{
    // ================= Director Ramp Inspection Controller Methods =================

    public function view()
    {
        $rampInspections = RampInspection::with('rampInspectionFinding')->get(); // preload findings
        return view('director.rampinspection.view', ['rampInspections' => $rampInspections]);
    }

    public function form()
    {
        return view('director.rampinspection.add');
    }
    ...
    public function create(Request $request)
    {
        ...
        return redirect()->route('director.rampinspection.view')
            ->with('status', 'Aircraft Inspection Form has been Created.');
    }

    public function edit($id)
    {
        $rampinspection = RampInspection::find($id);
        return view('director.rampinspection.update', ['rampinspection' => $rampinspection]);
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('director.rampinspection.view')
            ->with('status', 'Ramp Inspection Form has been removed.');
    }
    ...
    public function generatePdf($id)
    {
        ...
        return Pdf::loadView('director.rampinspection.pdf', compact('rampInspection'))
    ...
    public function exportRampInspectionsByDate(Request $request)
    {
        ...
        return Pdf::loadView('director.rampinspection.range_pdf', compact('rampInspections', 'start', 'end'))
            ->setPaper('a4', 'landscape')
    ...
    public function importExcel(Request $request)
    {
        ...
        return redirect()->route('director.rampinspection.view')
            ->with('success', 'Ramp Inspections imported successfully.');
    }
    ...
    public function findingView($id)
    {
        ...
        return view('director.rampinspection.finding.view', [
    ...
    {
        $rampInspection = RampInspection::find($id);
        return view('director.rampinspection.finding.add', ['rampInspection' => $rampInspection]);
    }
    ...
    public function findingCreate(Request $request)
    {
        ...
        return redirect()
            ->route('director.rampinspection.finding.view', $rampInspection->id)
    ...
    public function findingEdit($id)
    {
        ...
        return view('director.rampinspection.finding.update', [
    ...
    public function findingUpdate(Request $request, $id)
    {
        ...
        return redirect()
            ->route('director.rampinspection.finding.view', $rampInspectionFinding->rampInspection->id)
    ...
    public function printRampFinding($findingId)
    {
        ...
        $pdf = Pdf::loadView('director.rampinspection.finding.pdf', compact('rampInspection', 'finding'))
            ->setPaper('a4', 'landscape');
    ...
    public function exportRampFindingsByDateRange(Request $request, $rampId)
    {
        ...
        $pdf = Pdf::loadView('director.rampinspection.finding.range_pdf', compact('rampInspection', 'findings', 'startDate', 'endDate'))
            ->setPaper('a4', 'landscape');
     ...
     public function replyView($id)
    {
        ...
        return view('director.rampinspection.finding.reply.view', [
    ...
    public function replyForm($id)
    {
        ...
        return view('director.rampinspection.finding.reply.add', [
            'rampInspectionFinding' => $rampInspectionFinding,
        ]);
    }
    ...
    public function replyCreate(Request $request)
    {
        ...
        return redirect()
            ->route('director.rampinspection.finding.reply.view', $rampInspectionFinding->id)
    ...
    public function replyEdit($id)
    {
        ...
        return view('director.rampinspection.finding.reply.update', ['rampInspectionReply' => $rampInspectionReply]);
    }
    ...
    public function printRampReplies($replyId)
    {
        ...
        $pdf = Pdf::loadView('director.rampinspection.finding.reply.pdf', compact('rampInspection', 'finding', 'reply'))
            ->setPaper('a4', 'landscape');
    ...
    public function exportRepliesOfRampFindingByDateRange(Request $request, $findingId)
    {
        ...
        return Pdf::loadView('director.rampinspection.finding.reply.range_pdf', compact('rampInspection', 'finding', 'replies', 'startDate', 'endDate'))
            ->setPaper('a4', 'landscape')
