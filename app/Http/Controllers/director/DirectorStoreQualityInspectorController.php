...
class DirectorStoreQualityInspectorController extends Controller
{
    public function create()
    {
        ...
        return view('director.training.ses.store.add', compact('staff'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('director.training.view')->with('status', 'Store Quality Inspector added.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('director.training.ses.store.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('director.training.store_inspector.single', ['id' => $id])
    ...
    public function show($id)
    {
        ...
        return view('director.training.ses.store.single', compact('record'));
    }
    ...
    public function print($id)
    {
        ...
        return Pdf::loadView('director.training.ses.store.pdf', compact('record', 'training'))
