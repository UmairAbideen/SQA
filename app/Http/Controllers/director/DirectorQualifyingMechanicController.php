...
class DirectorQualifyingMechanicController extends Controller
{
    public function create()
    {
        ...
        return view('director.training.ses.qm.add', compact('staff'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('director.training.view')->with('status', 'Qualifying Mechanic added.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('director.training.ses.qm.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('director.training.qm.single', ['id' => $id])
    ...
    public function show($id)
    {
        ...
        return view('director.training.ses.qm.single', compact('record'));
    }
    ...
    public function print($id)
    {
        ...
        return Pdf::loadView('director.training.ses.qm.pdf', compact('record', 'training'))
