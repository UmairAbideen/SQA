...
class DirectorTrainingRecordSESController extends Controller
{
    public function create()
    {
        ...
        return view('director.training.ses.training.add', compact('staff'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('director.training.view')->with('status', 'Training record added.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('director.training.ses.training.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('director.training.training_ses.single', ['id' => $id])
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('director.training.view')->with('status', 'Training record deleted.');
    }

    public function show($id)
    {
        $record = TrainingRecordSES::with('staff.user')->findOrFail($id);
        return view('director.training.ses.training.single', compact('record'));
    }
