...
class DirectorTrainingRecordSaController extends Controller
{
    public function create()
    {
        ...
        return view('director.training.sa.training_sa.add', compact('staff'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('director.training.sa.training_sa.update', compact('record', 'staff'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('director.training.view')
            ->with('status', 'Training Record SA deleted.');
    }

    public function show($id)
    {
        $record = TrainingRecordSa::with('staff.user')->findOrFail($id);
        return view('director.training.sa.training_sa.single', compact('record'));
    }
