...
class TrainingRecordSaController extends Controller
{
    public function create()
    {
        ...
        $staff = Staff::with('user')
            ...
            ->get();
        return view('admin.training.sa.training_sa.add', compact('staff'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // Validate as nullable strings now instead of booleans
    ...
    public function edit($id)
    {
        ...
        return view('admin.training.sa.training_sa.update', compact('record', 'staff'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('admin.training_sa.single', $record->id)
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin.training.view')->with('status', 'Training Record SA deleted.');
    }

    public function show($id)
    {
        $record = TrainingRecordSa::with('staff.user')->findOrFail($id);
        return view('admin.training.sa.training_sa.single', compact('record'));
    }
