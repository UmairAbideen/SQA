...
@section('main-content')
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        ...
                        <div class="d-flex justify-content-end pe-2">
                            <a href="{{ route('auditor.audit.finding.view', $auditFindings->audit_id) }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                                    ...
                                    {{-- === REPLY IMPORT === --}}
                                    <form action="{{ route('auditor.reply.import') }}" method="post"
                                    ...
                                    @if ($auditFindings->reply)
                                        @foreach ($auditFindings->reply as $reply)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a href="{{ route('auditor.audit.finding.reply.print.pdf', $reply->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="Print">
                                                            <span class="material-icons"
                                                        ...
                                                        <a href="{{ route('auditor.audit.finding.reply.download.pdf', $reply->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="Download" download>
                                                            <span class="material-icons"
                                                        ...
                                                        <a href="{{ route('auditor.audit.finding.reply.edit', $reply->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="Update">
                                                            <span class="material-icons"
                                                        ...
                                                        <div class="modal fade" id="modal-delete-{{ $reply->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="{{ route('auditor.audit.finding.reply.delete', $reply->id) }}"
    ...
    <script>
        ...
        function exportAuditPdf() {
            ...
            const url = `/auditor/finding/${findingId}/reply/export/pdf?start_date=${startDate}&end_date=${endDate}`;
