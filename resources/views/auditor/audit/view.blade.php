...
@section('main-content')
                ...
                <div class="card my-4">
                    ...
                    <div class="row align-items-center px-3 pt-4 pb-5 g-3">
                        ...
                        <div class="col-12 col-md-2 d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                            ...
                            <a href="{{ route('auditor.audit.form') }}" class="btn bg-gradient-success w-100 w-md-auto"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        <form action="{{ route('auditor.audit.import') }}" method="post"
                                ...
                                <tbody>
                                    @foreach ($audits as $audit)
                                        <tr class="clickable-row"
                                            data-href="{{ route('auditor.audit.finding.view', $audit->id) }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <div>
                                                        <a href="{{ route('auditor.audit.print.pdf', $audit->id) }}"
                                                            target="_blank"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.audit.download.pdf', $audit->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.audit.edit', $audit->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('auditor.audit.delete', $audit->id) }}"
    ...
    <script>
        ...
        function exportAuditPdf() {
            ...
            const url = `{{ route('auditor.audit.range.pdf') }}?start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportAuditExcel() {
            ...
            const url = `{{ route('auditor.audit.range.excel') }}?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
