...
<head>
    <meta charset="utf-8">
    <title>Aircraft Inspection - Findings Report</title>
    <style>
        @page {
            margin: 40px 30px;
        }
...
<body>
    <div class="header">
        <div class="title">Aircraft Inspection - Findings Report</div>
    ...
    <div class="meta-info">
        ...
        <strong>Inspection Date:</strong> {{ \Carbon\Carbon::parse($rampInspection->date)->format('d-M-Y') }}<br>
    </div>
