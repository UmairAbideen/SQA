                ...
                <div class="card my-4">
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="d-flex justify-content-end pe-2">
                            <a href="{{ route('auditor.rampinspection.view') }}" class="btn bg-gradient-success"
                ...
                <div class="card my-4 mt-6">
                    ...
                    <div class="row align-items-center px-3 pt-4 pb-5 g-3">
                        ...
                        <div class="col-12 col-md-2 d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                            ...
                            <a href="{{ route('auditor.rampinspection.finding.form', $rampInspection->id) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        ...
                                        {{-- === FINDING IMPORT === --}}
                                        <form
                                            action="{{ route('auditor.rampinspection.finding.import', $rampInspection->id) }}"
                                ...
                                <tbody>
                                    @foreach ($rampInspection->rampInspectionFinding as $index => $finding)
                                        <tr class="clickable-row"
                                            data-href="{{ route('auditor.rampinspection.finding.reply.view', $finding->id) }}">
                                            ...
                                            <div class="modal fade" id="emailModal{{ $finding->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('auditor.rampinspection.finding.sendEmail', $finding->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-header">
...
Serene Eng. Services
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="d-flex justify-content-center align-items-center mt-3">
                                                    <a href="{{ route('auditor.rampinspection.finding.reply.view', $finding->id) }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.finding.print.pdf', $finding->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.finding.download.pdf', $finding->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.finding.edit', $finding->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('auditor.rampinspection.finding.delete', $finding->id) }}"
    ...
    <script>
        ...
        function exportRampFindingExcel(rampId) {
            ...
            const url =
                `/auditor/rampinspection/${rampId}/finding/export/excel?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
