...
@section('main-content')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        ...
                                        <form action="{{ route('auditor.rampinspection.import') }}" method="post"
                                ...
                                <tbody>
                                    @foreach ($rampInspections as $rampInspection)
                                        <tr class="clickable-row"
                                            data-href="{{ route('auditor.rampinspection.finding.view', $rampInspection->id) }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center mt-3">
                                                    ...
                                                    <a href="{{ route('auditor.rampinspection.finding.view.open', $rampInspection->id) }}"
                                                        class="btn bg-gradient-success ms-1 px-3 py-2" role="button">
                                                        Open ({{ $rampInspection->open_findings }})
                                                    </a>
                                                    <a href="{{ route('auditor.rampinspection.finding.view.close', $rampInspection->id) }}"
                                                        class="btn bg-gradient-secondary ms-1 px-3 py-2" role="button">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.print.pdf', $rampInspection->id) }}"
                                                            target="_blank"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.download.pdf', $rampInspection->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('auditor.rampinspection.edit', $rampInspection->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('auditor.rampinspection.delete', $rampInspection->id) }}"
    ...
    <script>
        ...
        function exportRampPdf() {
            ...
            const url = `{{ route('auditor.rampinspection.range.pdf') }}?start_date=${startDate}&end_date=${endDate}`;
