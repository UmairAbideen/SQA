<aside
    ...
    <div class="collapse navbar-collapse w-auto d-flex flex-column justify-content-between" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-manuals')" href="{{ route('auditee.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-ramp')" href="{{ route('auditee.rampinspection.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-audit')" href="{{ route('auditee.audit.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-training')" href="{{ route('auditee.training.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
