                    ...
                    <div class="container-fluid pt-4 pb-0">
                        <div class="d-flex flex-wrap align-items-start justify-content-between">
                            ...
                            <div class="d-flex flex-grow-1 justify-content-center gap-2 flex-wrap ps-3">
                                <!-- Staff -->
                                <a class="btn bg-gradient-success btn-sm" href="{{ route('director.staff.form') }}">
                                    + Staff
                                </a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('director.aircraft.create') }}">Add
                                                Aircraft Certifying Staff</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.component.create') }}">Add
                                                Component Certifying Staff</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.quality.create') }}">Add
                                                Quality Auditor</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('director.qualifiedmechanic.create') }}">Add Qualifying
                                                Mechanics</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.store_inspector.create') }}">Add
                                                Store Quality
                                                Inspector</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.standard_lab.create') }}">Add
                                                Standard Lab Personnel</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.training_ses.create') }}">Add
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('director.auditor.create') }}">Add
                                                Authorized Auditor</a></li>
                                        <li><a class="dropdown-item" href="{{ route('director.training_sa.create') }}">Add
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                            ...
                                            @php
                                                $imports = [
                                                    ['label' => 'Staff', 'route' => 'director.staff.import'],
                                                    [
                                                        'label' => 'Aircraft Certifying Staff',
                                                        'route' => 'director.aircraft.import',
                                                    ],
                                                    [
                                                        'label' => 'Component Certifying Staff',
                                                        'route' => 'director.component.import',
                                                    ],
                                                    [
                                                        'label' => 'Quality Auditors',
                                                        'route' => 'director.quality.import',
                                                    ],
                                                    [
                                                        'label' => 'Qualifying Mechanics',
                                                        'route' => 'director.qm.import',
                                                    ],
                                                    [
                                                        'label' => 'Store Quality Inspectors',
                                                        'route' => 'director.storeinspector.import',
                                                    ],
                                                    [
                                                        'label' => 'Standard Lab Personnel',
                                                        'route' => 'director.standard_lab.import',
                                                    ],
                                                    [
                                                        'label' => 'Training Record SES',
                                                        'route' => 'director.training_ses.import',
                                                    ],
                                                    [
                                                        'label' => 'Authorized Auditors',
                                                        'route' => 'director.auditor.import',
                                                    ],
                                                    [
                                                        'label' => 'Training Record SA',
                                                        'route' => 'director.training_sa.import',
                                                    ],
                                                ];
                                            @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                @if ($staff->aircraftCert && $staff->aircraftCert->id)
                                                    <div>
                                                        <a href="{{ route('director.training.acs.single', $staff->aircraftCert->id) }}"
                                                ...
                                                @if ($staff->componentCert && $staff->componentCert->id)
                                                    <div>
                                                        <a href="{{ route('director.training.ccs.single', $staff->componentCert->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Component Certifying Staff
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->qualityAuditor && $staff->qualityAuditor->id)
                                                    <div>
                                                        <a href="{{ route('director.training.quality.single', $staff->qualityAuditor->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Quality Auditor
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->qualifyingMechanic && $staff->qualifyingMechanic->id)
                                                    <div>
                                                        <a href="{{ route('director.training.qm.single', $staff->qualifyingMechanic->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Qualifying Mechanics
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->storeInspector && $staff->storeInspector->id)
                                                    <div>
                                                        <a href="{{ route('director.training.store_inspector.single', $staff->storeInspector->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Store Quality Inspector
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->labPersonnel && $staff->labPersonnel->id)
                                                    <div>
                                                        <a href="{{ route('director.training.standard_lab.single', $staff->labPersonnel->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Authorized Standard Lab Personnel
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->trainingSes && $staff->trainingSes->id)
                                                    <div>
                                                        <a href="{{ route('director.training.training_ses.single', $staff->trainingSes->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Training Record - SES
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->auditor && $staff->auditor->id)
                                                    <div>
                                                        <a href="{{ route('director.auditor.single', $staff->auditor->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Authorized Auditor
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->trainingSa && $staff->trainingSa->id)
                                                    <div>
                                                        <a href="{{ route('director.training_sa.single', $staff->trainingSa->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Training Record - SA
                                                        </a>
                                                    </div>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <a href="{{ route('director.staff.edit', $staff->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('director.staff.delete', $staff->id) }}"
