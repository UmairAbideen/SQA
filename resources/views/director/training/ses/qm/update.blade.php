                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Update Qualifying Mechanic</h6>
                        </div>
                        ...
                        <form class="px-3" action="{{ route('director.qualifiedmechanic.update', $record->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="date" name="auth_date" class="form-control"
                                            value="{{ old('auth_date', $record->auth_date) }}">
                                        @error('auth_date')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
