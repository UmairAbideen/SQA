                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="table-responsive p-0">
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                <div>
                                    <a href="{{ route('director.component.print', $record->id) }}"
                                ...
                                <div>
                                    <a href="{{ route('director.component.download', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        aria-pressed="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Download PDF">
                                ...
                                <div>
                                    <a href="{{ route('director.component.edit', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                ...
                                <div class="ps-1 pt-4 pb-3">
                                    <a href="#" class="btn bg-transparent btn-sm m-0 pt-2 btn-sm m-0"
                                        data-bs-toggle="modal" data-bs-target="#modal-delete-{{ $record->id }}"
                                        title="Delete Record">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title font-weight-normal">Delete Authorization</h6>
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('director.component.delete', $record->id) }}"
