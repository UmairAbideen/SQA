                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Aircraft Certifying Staff</h6>
                        </div>
                    </div>
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="table-responsive p-0">
                            <div class="row px-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    <strong>AML No:</strong> {{ $record->aml_no }}
                                </div>
                                <div class="col-md-4 mb-3">
                                    <strong>Aircraft:</strong> {{ $record->aircraft }}
                                </div>
                                <div class="col-md-4 mb-3">
                                    <strong>Category:</strong> {{ $record->cat }}
                                </div>
                                <div class="col-md-4 mb-3">
                                    <strong>Scope:</strong> {{ $record->scope }}
                                </div>
                                <div class="col-md-4 mb-3">
                                    <strong>Privileges:</strong> {{ $record->privileges }}
                                </div>
                                <div class="col-md-4 mb-3">
                                    <strong>AML Expiry:</strong>
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                <div>
                                    <a href="{{ route('director.aircraft.print', $record->id) }}"
                                        ...
                                        title="Print PDF" target="blank">
                                        <span class="material-icons" style="font-size: 1.5rem;">print</span>
                                    </a>
                                </div>

                                <div>
                                    <a href="{{ route('director.aircraft.download', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        aria-pressed="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Download PDF">
                                ...
                                <div>
                                    <a href="{{ route('director.aircraft.edit', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title font-weight-normal" id="modal-title-default">User
                                                        Deletion</h6>
                                                ...
                                                <div class="modal-body">
                                                    <p>Are you sure you want to remove this authorization?
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="{{ route('director.aircraft.delete', $record->id) }}"
