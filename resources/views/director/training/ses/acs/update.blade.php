                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Update Aircraft Certifying Staff</h6>
                        </div>
                        ...
                        <form class="px-3" action="{{ route('director.aircraft.update', $record->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="aml_no" class="form-control"
                                            value="{{ old('aml_no', $record->aml_no) }}">
                                        @error('aml_no')
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="aircraft" class="form-control"
                                            value="{{ old('aircraft', $record->aircraft) }}">
                                        @error('aircraft')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="text" name="privileges" class="form-control"
                                            value="{{ old('privileges', $record->privileges) }}">
                                        @error('privileges')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        <input type="date" name="aml_expiry" class="form-control"
                                            value="{{ old('aml_expiry', $record->aml_expiry) }}">
                                        @error('aml_expiry')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
