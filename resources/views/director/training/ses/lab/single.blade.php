                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Standard Lab Personnel</h6>
                        </div>
                    </div>
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="table-responsive p-0">
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                {{-- Print --}}
                                <div>
                                    <a href="{{ route('director.standard_lab.print', $record->id) }}"
                                ...
                                {{-- Download --}}
                                <div>
                                    <a href="{{ route('director.standard_lab.download', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        aria-pressed="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Download PDF">
                                ...
                                {{-- Edit --}}
                                <div>
                                    <a href="{{ route('director.standard_lab.edit', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                ...
                                <div class="ps-1 pt-4 pb-3">
                                    <a href="#" class="btn btn bg-transparent btn-sm m-0 pt-2" data-bs-toggle="modal"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Are you sure you want to remove this Standard Lab Personnel record?
                                                    </p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="{{ route('director.standard_lab.delete', $record->id) }}"
