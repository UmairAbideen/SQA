                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        <div class="table-responsive p-0">
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                <div>
                                    <a href="{{ route('director.storeinspector.print', $record->id) }}"
                                ...
                                <div>
                                    <a href="{{ route('director.storeinspector.download', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        aria-pressed="true" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Download PDF">
                                ...
                                {{-- Edit --}}
                                <div>
                                    <a href="{{ route('director.store_inspector.edit', $record->id) }}"
                                        class="btn bg-transparent btn-sm btn-tooltip m-0 ps-3 pt-4 pb-2" role="button"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('director.store_inspector.delete', $record->id) }}"
