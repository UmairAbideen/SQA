                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Create Audit Finding</h6>
                        </div>

                        <div class="d-flex justify-content-end pe-0 pt-4">
                            <a href="{{ route('director.audit.finding.view', $audit->id) }}" class="btn bg-gradient-success"
                                role="button" aria-pressed="true">Go
                                Back</a>
                        </div>

                        <form class='px-3' action="{{ route('director.audit.finding.create') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="input-group input-group-static mb-4">
                                        <label>Finding</label>
                                        <textarea name="finding" class="form-control" rows="1" cols="50">{{ old('finding') }}</textarea>
                                        @error('finding')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                                    </div>
