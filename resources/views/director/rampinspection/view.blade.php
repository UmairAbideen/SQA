...
@section('main-content')
                ...
                <div class="card my-4">
                    ...
                    <div class="row align-items-center px-3 pt-4 pb-5 g-3">
                        ...
                        <div class="col-12 col-md-2 d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                            ...
                            <a href="{{ route('director.rampinspection.form') }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        ...
                                        <form action="{{ route('director.rampinspection.import') }}" method="post"
                                ...
                                <tbody>
                                    @foreach ($rampInspections as $rampInspection)
                                        <tr class="clickable-row"
                                            data-href="{{ route('director.rampinspection.finding.view', $rampInspection->id) }}">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center mt-3">
                                                    <a href="{{ route('director.rampinspection.finding.view', $rampInspection->id) }}"
                                                        class="btn bg-gradient-secondary ms-1 px-3 py-2" role="button">
                                                        All ({{ $rampInspection->total_findings }})
                                                    </a>
                                                    <a href="{{ route('director.rampinspection.finding.view.open', $rampInspection->id) }}"
                                                        class="btn bg-gradient-success ms-1 px-3 py-2" role="button">
                                                        Open ({{ $rampInspection->open_findings }})
                                                    </a>
                                                    <a href="{{ route('director.rampinspection.finding.view.close', $rampInspection->id) }}"
                                                        class="btn bg-gradient-secondary ms-1 px-3 py-2" role="button">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.rampinspection.print.pdf', $rampInspection->id) }}"
                                                            target="_blank"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.rampinspection.download.pdf', $rampInspection->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('director.rampinspection.edit', $rampInspection->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('director.rampinspection.delete', $rampInspection->id) }}"
    ...
    <script>
        ...
        function exportRampPdf() {
            ...
            const url = `{{ route('director.rampinspection.range.pdf') }}?start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportRampExcel() {
            ...
            const url = `/director/rampinspection/export/excel?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
