...
@section('main-content')
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body ps-3 pe-2 pb-5 pt-4">
                        ...
                        <div class="d-flex justify-content-end pe-2">
                            <a href="{{ route('director.rampinspection.finding.view', $rampInspectionFindings->rampInspection->id) }}"
                ...
                <div class="card my-4 mt-6">
                    ...
                    <div class="row align-items-center px-3 pt-4 pb-5 g-3">
                        ...
                        <div class="col-12 col-md-2 d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                            ...
                            <a href="{{ route('director.rampinspection.finding.reply.form', $rampInspectionFindings->id) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        ...
                                        {{-- === REPLY IMPORT === --}}
                                        <form
                                            action="{{ route('director.rampinspection.finding.reply.import', $rampInspectionFindings->id) }}"
                                    ...
                                    @if ($rampInspectionFindings->rampInspectionReply)
                                        @foreach ($rampInspectionFindings->rampInspectionReply as $reply)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a href="{{ route('director.rampinspection.finding.reply.print.pdf', $reply->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="Print">
                                                            <span class="material-icons"
                                                        ...
                                                        <a href="{{ route('director.rampinspection.finding.reply.download.pdf', $reply->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="Download" download>
                                                            <span class="material-icons"
                                                        ...
                                                        <a href="{{ route('director.rampinspection.finding.reply.edit', $reply->id) }}"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            title="update">
                                                            <span class="material-icons"
                                                        ...
                                                        <div class="modal fade" id="modal-delete-{{ $reply->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="{{ route('director.rampinspection.finding.reply.delete', $reply->id) }}"
    ...
    <script>
        ...
        function exportRampPdf() {
            ...
            const url =
                `/director/rampinspection/finding/${rampFindingId}/reply/export/pdf?start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportRampReplyExcel(findingId) {
            ...
            const url =
                `/director/rampinspection/finding/${findingId}/reply/export/excel?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
    </script>
@endsection
