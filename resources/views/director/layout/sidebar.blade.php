<aside
    ...
    <div class="collapse navbar-collapse w-auto d-flex flex-column justify-content-between" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-manuals')" href="{{ route('director.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-ramp')" href="{{ route('director.rampinspection.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-audit')" href="{{ route('director.audit.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white @yield('active-link-training')" href="{{ route('director.training.view') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
