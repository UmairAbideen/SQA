                    ...
                    <div class="container-fluid pt-4 pb-0">
                        <div class="d-flex flex-wrap align-items-start justify-content-between">
                            ...
                            <div class="d-flex flex-grow-1 justify-content-center gap-2 flex-wrap ps-3">
                                <!-- Staff -->
                                <a class="btn bg-gradient-success btn-sm" href="{{ route('admin.staff.form') }}">
                                    + Staff
                                </a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('admin.aircraft.create') }}">Add
                                                Aircraft Certifying Staff</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.component.create') }}">Add
                                                Component Certifying Staff</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.quality.create') }}">Add
                                                Quality Auditor</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('admin.qualifiedmechanic.create') }}">Add Qualifying
                                                Mechanics</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.store_inspector.create') }}">Add
                                                Store Quality
                                                Inspector</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.standard_lab.create') }}">Add
                                                Standard Lab Personnel</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.training_ses.create') }}">Add
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('admin.auditor.create') }}">Add
                                                Authorized Auditor</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin.training_sa.create') }}">Add
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                @if ($staff->aircraftCert && $staff->aircraftCert->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.acs.single', $staff->aircraftCert->id) }}"
                                                ...
                                                @if ($staff->componentCert && $staff->componentCert->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.ccs.single', $staff->componentCert->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Component Certifying Staff
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->qualityAuditor && $staff->qualityAuditor->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.quality.single', $staff->qualityAuditor->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Quality Auditor
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->qualifyingMechanic && $staff->qualifyingMechanic->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.qm.single', $staff->qualifyingMechanic->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Qualifying Mechanics
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->storeInspector && $staff->storeInspector->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.store_inspector.single', $staff->storeInspector->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Store Quality Inspector
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->labPersonnel && $staff->labPersonnel->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.standard_lab.single', $staff->labPersonnel->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Authorized Standard Lab Personnel
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->trainingSes && $staff->trainingSes->id)
                                                    <div>
                                                        <a href="{{ route('admin.training.training_ses.single', $staff->trainingSes->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Training Record - SES
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->auditor && $staff->auditor->id)
                                                    <div>
                                                        <a href="{{ route('admin.auditor.single', $staff->auditor->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Authorized Auditor
                                                        </a>
                                                    </div>
                                                ...
                                                @if ($staff->trainingSa && $staff->trainingSa->id)
                                                    <div>
                                                        <a href="{{ route('admin.training_sa.single', $staff->trainingSa->id) }}"
                                                            class="text-primary text-decoration-underline">
                                                            Training Record - SA
                                                        </a>
                                                    </div>
