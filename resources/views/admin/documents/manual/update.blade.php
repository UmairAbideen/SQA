                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Update Manual</h6>
                        </div>
                        ...
                        <form class='px-3' action="{{ route('admin.document.manual.update', $manual->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 px-3">
                                    <div class="align-self-center my-4">
                                        <label>{{ basename($manual->pdf_file) }}.pdf</label><br>
