...
@section('main-content')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        <form action="{{ route('admin.audit.import') }}" method="post"
                                        ...
                                        <tr class="clickable-row"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <div>
                                                        <a href="{{ route('admin.audit.print.pdf', $audit->id) }}"
                                                            target="_blank"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('admin.audit.download.pdf', $audit->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
    ...
    <script>
        ...
        function exportAuditPdf() {
            ...
            const url = `{{ route('admin.audit.range.pdf') }}?start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportAuditExcel() {
            ...
            const url = `{{ route('admin.audit.range.excel') }}?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
    </script>
@endsection
