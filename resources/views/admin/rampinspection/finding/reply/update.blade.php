                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 my-0 z-index-2">
                        ...
                        <div class="d-flex justify-content-end pe-0 pt-4">
                            <a href="{{ route('admin.rampinspection.finding.reply.view', $rampInspectionReply->rampInspectionFinding->id) }}"
                                class="btn bg-gradient-success" role="button" aria-pressed="true">Go
                                Back</a>
                        </div>

                        <form class='px-3'
                            action="{{ route('admin.rampinspection.finding.reply.update', $rampInspectionReply->id) }}"
