                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="overflow-auto" style="max-height: 60vh; padding-right: 5px;">
                                        ...
                                        {{-- === FINDING IMPORT === --}}
                                        <form
                                            action="{{ route('admin.rampinspection.finding.import', $rampInspection->id) }}"
                                        ...
                                        <tr class="clickable-row"
                                            ...
                                            <div class="modal fade" id="emailModal{{ $finding->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('admin.rampinspection.finding.sendEmail', $finding->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-header">
...
Serene Eng. Services
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center align-items-center">
                                                    <div>
                                                        <a href="{{ route('admin.rampinspection.finding.print.pdf', $finding->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div>
                                                        <a href="{{ route('admin.rampinspection.finding.download.pdf', $finding->id) }}"
                                                            target="_blank"
                                                            class="btn bg-transparent btn-sm btn-tooltip m-0"
                                                            role="button" aria-pressed="true" data-bs-toggle="tooltip"
    ...
    <script>
        ...
        function exportRampPdf() {
            ...
            const url = `/admin/rampinspection/${rampId}/finding/export/pdf?start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportRampFindingExcel(rampId) {
            ...
            const url = `/admin/rampinspection/${rampId}/finding/export/excel?start_date=${startDate}&end_date=${endDate}`;
            window.open(url, '_blank');
        }
    </script>
@endsection
